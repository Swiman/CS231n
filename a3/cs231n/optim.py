...
def sgd(w, dw, config=None):
    ...
    #setdefault(x,y)-> if x is in the dict then return its key
    #else create the key x and set its value to y
...
def sgd_momentum(w, dw, config=None):
    ...
    """
    #get(x,y)-> if x is in the dict then return its key
    #else return y(don't create key x with value y)
